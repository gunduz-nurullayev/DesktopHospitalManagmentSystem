...
PreparedStatement pst=null;
 ...
 private void Get_Data(){
         try{
         String sql="Select ID as 'No', AdmitPatient_Room.AdmitID as 'Giriş No',PatientRegistration.PatientID as 'Xəstə No',PatientRegistration.PatientName as 'Xəstə ad soyad',PatientRegistration.Gen as 'Cins',PatientRegistration.BG as 'Qan qrupu',Disease,AdmitDate as 'Başlama tarixi',Room.RoomNo as 'Otaq No',Doctor.DoctorID as 'Həkim No',DoctorName as 'Həkim ad soyad',DischargeDate as 'Çıxış tarixi',DP_Remarks as 'Qeyd' from Room,Doctor,PatientRegistration,AdmitPatient_Room,DischargePatient_Room where Room.RoomNo=AdmitPatient_Room.RoomNo and Doctor.DoctorID=AdmitPatient_Room.DoctorID and PatientRegistration.PatientID=AdmitPatient_Room.PatientID  and AdmitPatient_Room.admitID= DischargePatient_Room.admitID order by Dischargedate";
