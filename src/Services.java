...
PreparedStatement pst=null;
 ...
 private void Get_Data1(){
      try{
        ...
        String sql="select PatientID as 'Xəstə No', PatientName as 'Xəstə ad' from Patientregistration order by PatientName";
 ...
 private void Reset()
{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Xidmətin adı");

        jLabel2.setText("Başlama tarixi");

        jLabel3.setText("Xəstə No");

        jLabel4.setText("Xəstə ad");

        jLabel5.setText("Xidmət haqqı");
    ...
    try{
            int P = JOptionPane.showConfirmDialog(null," Məlumatı silməyə əminsiniz ?","Confirmation",JOptionPane.YES_NO_OPTION);
            if (P==0)
            {
                con=Connect.ConnectDB();
