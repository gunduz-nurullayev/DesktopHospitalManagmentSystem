...
PreparedStatement pst=null;
 ...
 private void Get_Data(){
         try{
                 String sql="Select BillNo as 'Hesab No',DisChargePatient_Room.ID as 'Cıxış No', AdmitPatient_Room.AdmitID as 'Giriş No',PatientRegistration.PatientID as 'Xəstə No',PatientRegistration.PatientName as 'Xəstə ad soyad',PatientRegistration.Gen as 'Cins',PatientRegistration.BG as 'Qan qrupu',Disease as 'Xəstəlik',AdmitDate as 'Giriş tarixi',Room.RoomNo as 'Otaq No',Doctor.DoctorID as 'Həkim No',DoctorName as 'Həkim ad soyad',DischargeDate as 'Çıxış tarixi',Bill_Room.RoomCharges as 'Otaq haqqı',Bill_Room.ServiceCharges as 'Xidmət haqqı',Bill_Room.BillingDate as 'Hesab tarixi',PaymentMode as 'Ödəniş növü',PaymentModeDetails as 'Ödəniş növü detalları',TotalCharges as 'Ümumi məbləğ',ChargesPaid as 'Ödədiyi məbləğ',DueCharges as 'Qalıq borc',NoOfDays as 'Çarpayı sayı',TotalRoomCharges as 'Ümumi otaq qiyməti' from Room,Doctor,PatientRegistration,AdmitPatient_Room,DischargePatient_Room,Bill_Room where Room.RoomNo=AdmitPatient_Room.RoomNo and Doctor.DoctorID=AdmitPatient_Room.DoctorID and PatientRegistration.PatientID=AdmitPatient_Room.PatientID  and AdmitPatient_Room.admitID= DischargePatient_Room.admitID and Bill_Room.DischargeID=DischargePatient_Room.ID  order by Billingdate"; 
